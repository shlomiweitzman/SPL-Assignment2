...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class<? extends Message>, Callback<? extends Message>> operator;
    ...
    public MicroService(String name) {
        this.name = name;
        operator=new ConcurrentHashMap<Class<? extends Message>, Callback<? extends Message>>();
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                Message nextEv = messageBus.awaitMessage(this);
                Callback callback = operator.get(nextEv.getClass());
                if (callback != null)
                    callback.call(nextEv);
